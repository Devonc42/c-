...
void drawPoints()
{
    ...
    glClearColor(0.0, 0.45, 0.234, 1.0);
    ...
    for (x = -10; x <= 10; x++){
      h = x;
      k = (float)((x*x)-(x*x) + (2*x) + 1);
        plot2Dpoint(h,k,0,1,0);
    }//end x
	for (x = -10; x <= 10; x++){
      h = x;
      k = (float)((x*x)-(x*x) + (3*x) + 1);
        plot2Dpoint(h,k,1,1,0);
    }
    for (x = -10; x <= 10; x++){
      h = x;
      k = (float)((x*x)-(x*x) + (4*x) + 1);
        plot2Dpoint(h,k,2,1,0);
    }
    for (x = -10; x <= 10; x++){
      h = x;
      k = (float)((x*x)-(x*x) + (5*x) + 1);
        plot2Dpoint(h,k,3,1,0);
    }
    for (x = -10; x <= 10; x++){
      h = x;
      k = (float)((x*x)-(x*x) + (6*x) + 1);
        plot2Dpoint(h,k,4,1,0);
    }
    for (x = -10; x <= 10; x++){
      h = x;
      k = (float)((x*x)-(x*x) + (7*x) + 1);
        plot2Dpoint(h,k,5,1,0);
    }
    for (x = -10; x <= 10; x++){
      h = x;
      k = (float)((x*x)-(x*x) - (7*x) + 1);
